...
//getters
const Image*& Maxpool_layer::getOutput() const {
	return output;
}
int Maxpool_layer::getStride() const {
	return stride;
}

//setters
void Maxpool_layer::setOutput(const Image*& output) {
	this->output = output;
}
void Maxpool_layer::setStride(int stride) {
	this->stride = stride;
}
